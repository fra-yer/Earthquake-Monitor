...
<p align="center">
  <img src="docs/configuration1.jpg" width="300">
  <img src="docs/configuration2.jpg" width="300"
</p>
...
The entity of Earthquake Monitor records the used scale for a specific earthquake in the Magtype attribute. The most common scales are the Richter scale, which is represented by Magtype ml ("local magnitude"), and the "moment magnitude" scale represented by Magtype mw. In particular, for very large earthquakes, moment magnitude gives the [most reliable estimate](https://www.usgs.gov/faqs/moment-magnitude-richter-scale-what-are-different-magnitude-scales-and-why-are-there-so-many?utm_source=chatgpt.com) of earthquake size. The Richter scale was designed for shallow, regional earthquakes. Therefore, seismologists often use the moment magnitude scale to describe large quakes, as the original Richter scale becomes less accurate above magnitude 7.0. For general "felt" distances, the values remain comparable and differences are mainly of academic interest. This may be the reason that, although scientifically incorrect, Mw magnitudes are often referred to as "Richter scale" values in the general press. 
